...
abstract class SpringTestCase {
    ...
    companion object {
        lateinit var oldClassOne: OldClass
        lateinit var oldClassTwo: OldClass
        ...
        lateinit var databaseTeamThree: Team
        var databaseTeams = mutableListOf<Team>()
    ...
    open fun setup() {
        ...
        oldClassOne = OldClass(1, "Herren", 0)
        oldClassTwo = OldClass(2, "A-Junioren", 1)
        databaseTeamOne = Team(1, "Herren 1. Mannschaft", hashMapOf(Pair("Friday", "19:00")),
                "011MICFJLG000000VTVG0001VTR8C1K7", 0, 1)
        databaseTeamTwo = Team(2, "Herren 2. Mannschaft", hashMapOf(Pair("Friday", "19:00")),
                "011MICFJLG000000VTVG0001VTR8C1K7", 1, 1)
        databaseTeamThree = Team(3, "A-Junioren", hashMapOf(Pair("Friday", "19:00")), "test", 0, 2)
        oldClassOne.teams = listOf(databaseTeamOne, databaseTeamTwo)
        oldClassTwo.teams = listOf(databaseTeamThree)
        databaseTeams.add(databaseTeamOne)
        databaseTeams.add(databaseTeamTwo)
        databaseTeams.add(databaseTeamThree)
